    ...
    return (
        <div className=' flex flex-wrap justify-between '>
            <div className='flex flex-wrap md:gap-[13%] md:w-[70%]'>
                ...
                <div className='flex flex-col md:gap-2 my-[15px] md:my-[0px]'>
                    ...
                    <div className='flex flex-wrap gap-[10px] md:gap-5 text-[24px]'>
                        <h1 className='flex items-center'>
                            ...
                            200
                            <span className='bg-gray-400 ml-[4px] md:ml-[10px] text-gray-500 rounded-lg text-[14px] px-[8px] py-[2px] font-light '>BTC</span></h1>
