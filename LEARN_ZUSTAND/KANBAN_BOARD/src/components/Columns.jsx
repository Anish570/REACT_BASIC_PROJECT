    ...
    return (
        <>
            <div onDragOver={(e) => {
                ...
                className={`${drop ? "border-dashed border-white border-[2px]" : " border-transparent border-[2px]"} min-h-[15rem] bg-gray-800 w-[33%] max-w-[15rem] mx-[0.5rem] p-[0.5rem] rounded-md`}>
                ...
                {
                    tasks.map((task) => (<Task title={task.title} onOpen={onOpen} key={task.title} />))
                }
